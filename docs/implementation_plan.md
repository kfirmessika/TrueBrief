# TrueBrief v2 — Implementation Plan
...
>
> 📌 **Read first:** [AI Rules & Workflow](file:///d:/projects/Apps/TrueBrief/docs/ai_rules.md) → then [Roadmap](file:///d:/projects/Apps/TrueBrief/docs/roadmap.md) (where we are) → then this file (how to build it) → then [Architecture](file:///d:/projects/Apps/TrueBrief/docs/architecture.md) (full theory).  
> 📄 **Definitive Plan (archived copy):** [truebrief_definitive_plan_v2.md](file:///C:/Users/user/.gemini/antigravity/brain/fcdcef8e-4468-4487-83f0-1dcf93b114aa/truebrief_definitive_plan_v2.md)
